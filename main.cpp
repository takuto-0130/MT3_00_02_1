...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Matrix4x4 resultSubtruct = Subtract(m1, m2);
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreeenPrintf(0, 0, resultAdd, "Add");
		MatrixScreeenPrintf(0, kRowHeight * 5, resultSubtruct, "Subtruct");
		MatrixScreeenPrintf(0, kRowHeight  * 5 * 2, resultMultiply, "Multiply");
		MatrixScreeenPrintf(0, kRowHeight * 5 * 3, InverseM1, "InverseM1");
		MatrixScreeenPrintf(0, kRowHeight * 5 * 4, InverseM2, "InverseM2");
		MatrixScreeenPrintf(kColumnWidth * 5, 0, transposeM1, "transposeM1");
		MatrixScreeenPrintf(kColumnWidth * 5, kRowHeight * 5, transposeM2, "transposeM2");
		MatrixScreeenPrintf(kColumnWidth * 5, kRowHeight * 5 * 2, identity, "identity");
